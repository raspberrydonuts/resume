...
\begin{cventries}
	...
	{\begin{cvitems}
		\vspace{-4mm}
		\item {Created a personal website (link at top of resume) with \textbf{React}} 
		\item {Building a data analytics engine with \textbf{Express.js} and \textbf{Node.js} integrated with the front-end to monitor site traffic data}
